...
const float NORMALIZATION_RADIUS = 1.0;
const float MAX_ABS_RANDOM_WEIGHTS = 0.01;
const bool LAPTOP = 1;
const bool LOCAL_DATA = 1;
const bool ADAPT_PROCESSORS_LOAD = 0;
const bool FOCUSED_TRAINING = 0;
const float FOCUSED_PROBABILITY_THRESHOLD = 0.5;
const bool PARALLEL_ARCHITECTURE = 1;
const int INPUT_DEPTH = 0;
const bool READ_TO_VECT = 0;

const bool DATA_AUGMENTATION = 0;
const float AUGMENTATION_SIZE = 0.2;
const float CORNER_PROBABILITY = 0.5;

const bool DROP_DATA_AUGMENTATION = 0;
const float INPUT_UNCHANGED_PROBABILITY = 0.0625;
const float INPUT_DROP_RATE = 0.0625;
...
const float RATE_DECAY = 0.97;

const int MAX_THREADS = 50;

const float DEFAULT_ALPHA_DROP = 0.2;
const float DEFAULT_P_DROP = 0.25;
const float DEFAULT_P_NOT_DROP = 0.0;


const bool UNIFORM_DROP_INCREASE = 1;

const float DEFAULT_ALPHA_START = 1.0;
const float DEFAULT_ALPHA_END = 1.0;

const float DEFAULT_PDROP_START = 0.0625;
const float DEFAULT_PDROP_END = 0.5;

const float DEFAULT_PNOTDROP_START = 0.0;
const float DEFAULT_PNOTDROP_END = 0.0;
