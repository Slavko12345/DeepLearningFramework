...
void weights::SetModel()
{
    ...
    weightList[0].SetStairsFullConvolution(3, 4, 10);

    weightList[1].SetStairsFullConvolution(83, 4, 10);

    weightList[2].SetStairsFullConvolution(163, 4, 10);

    weightList[3].SetFC(243, 10);
}
